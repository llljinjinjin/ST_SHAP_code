This folder holds the `SHAP_explain_mean.py` file for interpretable, which runs need to load the model files stored in `model/seed` with the preprocessed data in `datainput/input_4`.
